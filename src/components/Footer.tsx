      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">NearGo</h3>
            <p className="text-sm text-gray-600">
              For a better experience, download the NearGo app now.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/support" className="text-gray-600 hover:text-primary">Help & Support</Link></li>
        ...
        <div className="mt-12 pt-8 border-t">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">
              © 2024 NearGo. All rights reserved.
            </p>
